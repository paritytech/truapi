...
export const versions: ExplorerVersion[] = [
  {
    ...
    dataTypes: [
      ...
      },
      {
        ...
        category: "struct",
        definition:
          "interface LegacyAccountTxPayload { signer: AccountId; genesisHash: GenesisHash; callData: HexString; extensions: Array<TxPayloadExtension>; txExtVersion: number }",
        description:
      ...
      },
      {
        ...
        category: "struct",
        definition:
          "interface ProductAccountTxPayload { signer: ProductAccountId; genesisHash: GenesisHash; callData: HexString; extensions: Array<TxPayloadExtension>; txExtVersion: number }",
        description:
      ...
      },
      {
        ...
        category: "struct",
        definition:
          "interface TxPayloadExtension { id: string; extra: HexString; additionalSigned: HexString }",
