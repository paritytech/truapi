...
export class AccountManagementClient {
  ...
  async accountGet(request: T.HostAccountGetRequest): Promise<Result<T.HostAccountGetResponse, T.HostAccountGetError>> {
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostAccountGetResponse, T.HostAccountGetError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Retrieve a contextual alias for a product account. */
  async accountGetAlias(request: T.HostAccountGetAliasRequest): Promise<Result<T.HostAccountGetAliasResponse, T.HostAccountGetError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostAccountGetAliasResponse, T.HostAccountGetError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Generate a ring VRF proof for a product account. */
  async accountCreateProof(request: T.HostAccountCreateProofRequest): Promise<Result<T.HostAccountCreateProofResponse, T.HostAccountCreateProofError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.HostAccountCreateProofResponse, T.HostAccountCreateProofError>
    >({
      ids: W.HOST_ACCOUNT_CREATE_PROOF,
      payload: T.VersionedHostAccountCreateProofRequest.enc({ tag: "V1", value: request }),
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostAccountCreateProofResponse, T.HostAccountCreateProofError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** List non-product accounts the user owns. */
  async getLegacyAccounts(): Promise<Result<T.HostGetLegacyAccountsResponse, T.HostAccountGetError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostGetLegacyAccountsResponse, T.HostAccountGetError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Fetch the user's primary identity (V0.2+). */
  async getUserId(): Promise<Result<T.HostGetUserIdResponse, T.HostGetUserIdError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostGetUserIdResponse, T.HostGetUserIdError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
   ...
   */
  async requestLogin(request: T.HostRequestLoginRequest): Promise<Result<T.HostRequestLoginResponse, T.HostRequestLoginError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostRequestLoginResponse, T.HostRequestLoginError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
...
export class ChainInteractionClient {
  ...
  chainHeadFollowSubscribe({ request }: { request: T.RemoteChainHeadFollowRequest }): ObservableLike<T.RemoteChainHeadFollowItem> {
  ...
  async chainHeadHeader(request: T.RemoteChainHeadHeaderRequest): Promise<Result<T.RemoteChainHeadHeaderResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemoteChainHeadHeaderResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Fetch a block body. */
  async chainHeadBody(request: T.RemoteChainHeadBodyRequest): Promise<Result<T.RemoteChainHeadBodyResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemoteChainHeadBodyResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Query runtime storage at a specific block. */
  async chainHeadStorage(request: T.RemoteChainHeadStorageRequest): Promise<Result<T.RemoteChainHeadStorageResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemoteChainHeadStorageResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Invoke a runtime call at a specific block. */
  async chainHeadCall(request: T.RemoteChainHeadCallRequest): Promise<Result<T.RemoteChainHeadCallResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemoteChainHeadCallResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Release pinned blocks. */
  async chainHeadUnpin(request: T.RemoteChainHeadUnpinRequest): Promise<Result<undefined, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(S._void, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Continue a paused chain-head operation. */
  async chainHeadContinue(request: T.RemoteChainHeadContinueRequest): Promise<Result<undefined, T.GenericError>> {
    const result = await this.transport.request<
      S.ResultPayload<undefined, T.GenericError>
    >({
  ...
  async chainHeadStopOperation(request: T.RemoteChainHeadStopOperationRequest): Promise<Result<undefined, T.GenericError>> {
    const result = await this.transport.request<
      S.ResultPayload<undefined, T.GenericError>
    >({
  ...
  async chainSpecGenesisHash(request: T.RemoteChainSpecGenesisHashRequest): Promise<Result<T.RemoteChainSpecGenesisHashResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemoteChainSpecGenesisHashResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Fetch the display name of a chain. */
  async chainSpecChainName(request: T.RemoteChainSpecChainNameRequest): Promise<Result<T.RemoteChainSpecChainNameResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemoteChainSpecChainNameResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Fetch the JSON-encoded properties of a chain. */
  async chainSpecProperties(request: T.RemoteChainSpecPropertiesRequest): Promise<Result<T.RemoteChainSpecPropertiesResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemoteChainSpecPropertiesResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Broadcast a signed transaction. */
  async chainTransactionBroadcast(request: T.RemoteChainTransactionBroadcastRequest): Promise<Result<T.RemoteChainTransactionBroadcastResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemoteChainTransactionBroadcastResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Stop a transaction broadcast. */
  async chainTransactionStop(request: T.RemoteChainTransactionStopRequest): Promise<Result<undefined, T.GenericError>> {
    const result = await this.transport.request<
      S.ResultPayload<undefined, T.GenericError>
    >({
...
export class ChatClient {
  ...
  /** Create a chat room. */
  async chatCreateRoom(request: T.HostChatCreateRoomRequest): Promise<Result<T.HostChatCreateRoomResponse, T.HostChatCreateRoomError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostChatCreateRoomResponse, T.HostChatCreateRoomError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Register a chat bot. */
  async chatRegisterBot(request: T.HostChatRegisterBotRequest): Promise<Result<T.HostChatRegisterBotResponse, T.HostChatRegisterBotError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostChatRegisterBotResponse, T.HostChatRegisterBotError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
  ...
  async chatPostMessage(request: T.HostChatPostMessageRequest): Promise<Result<T.HostChatPostMessageResponse, T.HostChatPostMessageError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostChatPostMessageResponse, T.HostChatPostMessageError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
   ...
   */
  chatCustomMessageRenderSubscribe({ request }: { request: T.ProductChatCustomMessageRenderSubscribeRequest }): ObservableLike<T.CustomRendererNode> {
...
export class EntropyDerivationClient {
   ...
   * given key.
   */
  async deriveEntropy(request: T.HostDeriveEntropyRequest): Promise<Result<T.HostDeriveEntropyResponse, T.HostDeriveEntropyError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostDeriveEntropyResponse, T.HostDeriveEntropyError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
...
export class JsonRpcClient {
  ...
  async jsonrpcMessageSend(request: T.HostJsonrpcMessageSendRequest): Promise<Result<undefined, T.GenericError>> {
    const result = await this.transport.request<
      S.ResultPayload<undefined, T.GenericError>
    >({
      ids: W.HOST_JSONRPC_MESSAGE_SEND,
      payload: T.VersionedHostJsonrpcMessageSendRequest.enc({ tag: "V1", value: request }),
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(S._void, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
  ...
  jsonrpcMessageSubscribe({ request }: { request: T.HostJsonrpcMessageSubscribeRequest }): ObservableLike<T.HostJsonrpcMessageSubscribeItem> {
    return createObservable<T.HostJsonrpcMessageSubscribeItem>({
      transport: this.transport,
      ids: W.HOST_JSONRPC_MESSAGE_SUBSCRIBE,
      payload: T.VersionedHostJsonrpcMessageSubscribeRequest.enc({ tag: "V1", value: request }),
      decodeItem: (payload) => (T.VersionedHostJsonrpcMessageSubscribeItem.dec(payload) as { tag: "V1"; value: T.HostJsonrpcMessageSubscribeItem } & T.VersionedHostJsonrpcMessageSubscribeItem).value,
    });
  }
...
export class LocalStorageClient {
  ...
  /** Read a value by key. */
  async localStorageRead(request: T.HostLocalStorageReadRequest): Promise<Result<T.HostLocalStorageReadResponse, T.HostLocalStorageReadError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.HostLocalStorageReadResponse, T.HostLocalStorageReadError>
    >({
      ids: W.HOST_LOCAL_STORAGE_READ,
      payload: T.VersionedHostLocalStorageReadRequest.enc({ tag: "V1", value: request }),
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostLocalStorageReadResponse, T.HostLocalStorageReadError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Write a value to a key. */
  async localStorageWrite(request: T.HostLocalStorageWriteRequest): Promise<Result<undefined, T.HostLocalStorageReadError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(S._void, T.HostLocalStorageReadError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Clear a value by key. */
  async localStorageClear(request: T.HostLocalStorageClearRequest): Promise<Result<undefined, T.HostLocalStorageReadError>> {
    const result = await this.transport.request<
      S.ResultPayload<undefined, T.HostLocalStorageReadError>
    >({
...
export class PaymentClient {
  ...
  paymentBalanceSubscribe(): ObservableLike<T.HostPaymentBalanceSubscribeItem, T.HostPaymentBalanceSubscribeError> {
    return createObservable<T.HostPaymentBalanceSubscribeItem, T.HostPaymentBalanceSubscribeError>({
      transport: this.transport,
      ids: W.HOST_PAYMENT_BALANCE_SUBSCRIBE,
      payload: T.VersionedHostPaymentBalanceSubscribeRequest.enc({ tag: "V1", value: undefined }),
      ...
      decodeInterrupt: (payload) => (T.VersionedHostPaymentBalanceSubscribeError.dec(payload) as { tag: "V1"; value: T.HostPaymentBalanceSubscribeError } & T.VersionedHostPaymentBalanceSubscribeError).value,
    });
  }

  /** Request a payment from the user. */
  async paymentRequest(request: T.HostPaymentRequestRequest): Promise<Result<T.HostPaymentRequestResponse, T.HostPaymentRequestError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.HostPaymentRequestResponse, T.HostPaymentRequestError>
    >({
      ids: W.HOST_PAYMENT_REQUEST,
      payload: T.VersionedHostPaymentRequestRequest.enc({ tag: "V1", value: request }),
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostPaymentRequestResponse, T.HostPaymentRequestError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Subscribe to payment lifecycle updates for a specific payment. */
  paymentStatusSubscribe({ request }: { request: T.HostPaymentStatusSubscribeRequest }): ObservableLike<T.HostPaymentStatusSubscribeItem, T.HostPaymentStatusSubscribeError> {
    return createObservable<T.HostPaymentStatusSubscribeItem, T.HostPaymentStatusSubscribeError>({
      transport: this.transport,
      ...
      decodeInterrupt: (payload) => (T.VersionedHostPaymentStatusSubscribeError.dec(payload) as { tag: "V1"; value: T.HostPaymentStatusSubscribeError } & T.VersionedHostPaymentStatusSubscribeError).value,
    });
  }

  /** Top up the user's payment balance. */
  async paymentTopUp(request: T.HostPaymentTopUpRequest): Promise<Result<undefined, T.HostPaymentTopUpError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(S._void, T.HostPaymentTopUpError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
...
export class PermissionsClient {
  ...
  async devicePermission(request: T.HostDevicePermissionRequest): Promise<Result<T.HostDevicePermissionResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostDevicePermissionResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Request one or more remote-operation permissions. */
  async permission(request: T.RemotePermissionRequest): Promise<Result<T.RemotePermissionResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemotePermissionResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
...
export class PreimageClient {
  ...
  preimageLookupSubscribe({ request }: { request: T.RemotePreimageLookupSubscribeRequest }): ObservableLike<T.RemotePreimageLookupSubscribeItem> {
  ...
  async preimageSubmit(request: HexString): Promise<Result<HexString, T.PreimageSubmitError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(S.Hex(), T.PreimageSubmitError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
...
export class ResourceAllocationClient {
   ...
   */
  async requestResourceAllocation(request: T.HostRequestResourceAllocationRequest): Promise<Result<T.HostRequestResourceAllocationResponse, T.ResourceAllocationError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.HostRequestResourceAllocationResponse, T.ResourceAllocationError>
    >({
      ids: W.HOST_REQUEST_RESOURCE_ALLOCATION,
      payload: T.VersionedHostRequestResourceAllocationRequest.enc({ tag: "V1", value: request }),
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostRequestResourceAllocationResponse, T.ResourceAllocationError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
...
export class SigningClient {
  ...
  async createTransaction(request: T.HostCreateTransactionRequest): Promise<Result<T.HostCreateTransactionResponse, T.HostCreateTransactionError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.HostCreateTransactionResponse, T.HostCreateTransactionError>
    >({
      ids: W.HOST_CREATE_TRANSACTION,
      payload: T.VersionedHostCreateTransactionRequest.enc({ tag: "V1", value: request }),
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostCreateTransactionResponse, T.HostCreateTransactionError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Construct a signed extrinsic for a non-product account. */
  async createTransactionWithLegacyAccount(request: T.HostCreateTransactionWithLegacyAccountRequest): Promise<Result<T.HostCreateTransactionWithLegacyAccountResponse, T.HostCreateTransactionError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.HostCreateTransactionWithLegacyAccountResponse, T.HostCreateTransactionError>
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostCreateTransactionWithLegacyAccountResponse, T.HostCreateTransactionError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Sign raw bytes with a non-product (legacy) account. */
  async signRawWithLegacyAccount(request: T.HostSignRawWithLegacyAccountRequest): Promise<Result<T.HostSignPayloadResponse, T.HostSignPayloadError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostSignPayloadResponse, T.HostSignPayloadError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Sign a Substrate extrinsic payload with a non-product (legacy) account. */
  async signPayloadWithLegacyAccount(request: T.HostSignPayloadWithLegacyAccountRequest): Promise<Result<T.HostSignPayloadResponse, T.HostSignPayloadError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.HostSignPayloadResponse, T.HostSignPayloadError>
    >({
  ...
  async signRaw(request: T.HostSignRawRequest): Promise<Result<T.HostSignPayloadResponse, T.HostSignPayloadError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.HostSignPayloadResponse, T.HostSignPayloadError>
    >({
      ids: W.HOST_SIGN_RAW,
  ...
  async signPayload(request: T.HostSignPayloadRequest): Promise<Result<T.HostSignPayloadResponse, T.HostSignPayloadError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.HostSignPayloadResponse, T.HostSignPayloadError>
    >({
...
export class StatementStoreClient {
  ...
  statementStoreSubscribe({ request }: { request: T.RemoteStatementStoreSubscribeRequest }): ObservableLike<T.RemoteStatementStoreSubscribeItem> {
  ...
  async statementStoreCreateProof(request: T.RemoteStatementStoreCreateProofRequest): Promise<Result<T.RemoteStatementStoreCreateProofResponse, T.RemoteStatementStoreCreateProofError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.RemoteStatementStoreCreateProofResponse, T.RemoteStatementStoreCreateProofError>
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.RemoteStatementStoreCreateProofResponse, T.RemoteStatementStoreCreateProofError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
   ...
   */
  async statementStoreCreateProofAuthorized(request: T.Statement): Promise<Result<T.RemoteStatementStoreCreateProofResponse, T.RemoteStatementStoreCreateProofError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.RemoteStatementStoreCreateProofResponse, T.RemoteStatementStoreCreateProofError>
    >({
   ...
   */
  async statementStoreSubmit(request: T.SignedStatement): Promise<Result<undefined, T.GenericError>> {
    const result = await this.transport.request<
      S.ResultPayload<undefined, T.GenericError>
    >({
...
export class TrUApiCallsClient {
  ...
  async handshake(): Promise<Result<undefined, T.HostHandshakeError>> {
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(S._void, T.HostHandshakeError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Queries whether the host supports a specific feature. */
  async featureSupported(request: T.HostFeatureSupportedRequest): Promise<Result<T.HostFeatureSupportedResponse, T.GenericError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(T.HostFeatureSupportedResponse, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
   ...
   */
  async pushNotification(request: T.NotificationsHostPushNotificationRequest): Promise<Result<T.NotificationsHostPushNotificationResponse, T.NotificationsHostPushNotificationError>> {
    const result = await this.transport.request<
      S.ResultPayload<T.NotificationsHostPushNotificationResponse, T.NotificationsHostPushNotificationError>
    >({
      ids: W.HOST_PUSH_NOTIFICATION,
      payload: T.VersionedHostPushNotificationRequest.enc({ tag: "V2", value: request }),
      decodeResponse: (payload) => S.indexedTaggedUnion({V2: [1, S.Result(T.NotificationsHostPushNotificationResponse, T.NotificationsHostPushNotificationError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
   ...
   */
  async pushNotificationCancel(request: T.NotificationsHostPushNotificationCancelRequest): Promise<Result<undefined, T.GenericError>> {
    const result = await this.transport.request<
      S.ResultPayload<undefined, T.GenericError>
    >({
      ids: W.HOST_PUSH_NOTIFICATION_CANCEL,
      payload: T.VersionedHostPushNotificationCancelRequest.enc({ tag: "V2", value: request }),
      decodeResponse: (payload) => S.indexedTaggedUnion({V2: [1, S.Result(S._void, T.GenericError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }

  /** Requests the host to open a URL. */
  async navigateTo(request: T.HostNavigateToRequest): Promise<Result<undefined, T.HostNavigateToError>> {
    const result = await this.transport.request<
    ...
    >({
      ...
      decodeResponse: (payload) => S.indexedTaggedUnion({V1: [0, S.Result(S._void, T.HostNavigateToError)] as const}).dec(payload).value,
    });
    return result.success ? ok(result.value) : err(result.value);
  }
