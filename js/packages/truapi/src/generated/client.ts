...
export class SigningClient {
  ...
  async createTransaction(request: T.ProductAccountTxPayload): Promise<Result<T.HostCreateTransactionResponse, T.HostCreateTransactionError>> {
    const result = await this.transport.request<
  ...
  async createTransactionWithLegacyAccount(request: T.LegacyAccountTxPayload): Promise<Result<T.HostCreateTransactionWithLegacyAccountResponse, T.HostCreateTransactionError>> {
    const result = await this.transport.request<
...
export class TrUApiCallsClient {
  ...
  async pushNotification(request: T.HostPushNotificationRequest): Promise<Result<undefined, T.GenericError>> {
    const result = await this.transport.request<
      S.ResultPayload<undefined, T.GenericError>
    >({
