...
export const VersionedHostPushNotificationCancelError: S.Codec<VersionedHostPushNotificationCancelError> =
  S.lazy(
    (): S.Codec<VersionedHostPushNotificationCancelError> =>
      S.indexedTaggedUnion({ V2: [1, GenericError] as const }),
  );

/** Versioned envelope for [`HostPushNotificationCancelRequest`]. */
export type VersionedHostPushNotificationCancelRequest = {
  tag: "V2";
  value: NotificationsHostPushNotificationCancelRequest;
};

export const VersionedHostPushNotificationCancelRequest: S.Codec<VersionedHostPushNotificationCancelRequest> =
  S.lazy(
    (): S.Codec<VersionedHostPushNotificationCancelRequest> =>
      S.indexedTaggedUnion({
        V2: [1, NotificationsHostPushNotificationCancelRequest] as const,
      }),
  );
...
export const VersionedHostPushNotificationCancelResponse: S.Codec<VersionedHostPushNotificationCancelResponse> =
  S.lazy(
    (): S.Codec<VersionedHostPushNotificationCancelResponse> =>
      S.indexedTaggedUnion({ V2: [1, S._void] as const }),
  );

/** Versioned envelope for [`HostPushNotificationError`]. */
export type VersionedHostPushNotificationError = {
  tag: "V2";
  value: NotificationsHostPushNotificationError;
};
...
export const VersionedHostPushNotificationError: S.Codec<VersionedHostPushNotificationError> =
  S.lazy(
    (): S.Codec<VersionedHostPushNotificationError> =>
      S.indexedTaggedUnion({
        V2: [1, NotificationsHostPushNotificationError] as const,
      }),
  );
...
export type VersionedHostPushNotificationRequest = {
  tag: "V2";
  value: NotificationsHostPushNotificationRequest;
};
...
export const VersionedHostPushNotificationRequest: S.Codec<VersionedHostPushNotificationRequest> =
  S.lazy(
    (): S.Codec<VersionedHostPushNotificationRequest> =>
      S.indexedTaggedUnion({
        V2: [1, NotificationsHostPushNotificationRequest] as const,
      }),
  );
...
export type VersionedHostPushNotificationResponse = {
  tag: "V2";
  value: NotificationsHostPushNotificationResponse;
};
...
export const VersionedHostPushNotificationResponse: S.Codec<VersionedHostPushNotificationResponse> =
  S.lazy(
    (): S.Codec<VersionedHostPushNotificationResponse> =>
      S.indexedTaggedUnion({
        V2: [1, NotificationsHostPushNotificationResponse] as const,
      }),
  );
...
export const NotificationId: S.Codec<NotificationId> = S.lazy(
  (): S.Codec<NotificationId> => S.u32,
);
...
export const NotificationsHostPushNotificationCancelRequest: S.Codec<NotificationsHostPushNotificationCancelRequest> =
  S.lazy(
    (): S.Codec<NotificationsHostPushNotificationCancelRequest> =>
      S.Struct({
        id: NotificationId,
      }) as S.Codec<NotificationsHostPushNotificationCancelRequest>,
  );
...
export const NotificationsHostPushNotificationError: S.Codec<NotificationsHostPushNotificationError> =
  S.lazy(
    (): S.Codec<NotificationsHostPushNotificationError> =>
      S.Enum({
...
export const NotificationsHostPushNotificationRequest: S.Codec<NotificationsHostPushNotificationRequest> =
  S.lazy(
    (): S.Codec<NotificationsHostPushNotificationRequest> =>
      S.Struct({
        text: S.str,
        deeplink: S.Option(S.str),
        scheduledAt: S.Option(S.u64),
      }) as S.Codec<NotificationsHostPushNotificationRequest>,
  );
...
export const NotificationsHostPushNotificationResponse: S.Codec<NotificationsHostPushNotificationResponse> =
  S.lazy(
    (): S.Codec<NotificationsHostPushNotificationResponse> =>
      S.Struct({
        id: NotificationId,
      }) as S.Codec<NotificationsHostPushNotificationResponse>,
  );
