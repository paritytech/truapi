...
export const VersionedHostCreateTransactionRequest: S.Codec<VersionedHostCreateTransactionRequest> =
  S.lazy(
    (): S.Codec<VersionedHostCreateTransactionRequest> =>
      S.indexedTaggedUnion({ V1: [0, ProductAccountTxPayload] as const }),
  );
...
export const VersionedHostCreateTransactionWithLegacyAccountRequest: S.Codec<VersionedHostCreateTransactionWithLegacyAccountRequest> =
  S.lazy(
    (): S.Codec<VersionedHostCreateTransactionWithLegacyAccountRequest> =>
      S.indexedTaggedUnion({ V1: [0, LegacyAccountTxPayload] as const }),
  );
...
export const LegacyAccountTxPayload: S.Codec<LegacyAccountTxPayload> = S.lazy(
  (): S.Codec<LegacyAccountTxPayload> =>
    S.Struct({
      signer: AccountId,
      genesisHash: GenesisHash,
      callData: S.Hex(),
      ...
      txExtVersion: S.u8,
    }) as S.Codec<LegacyAccountTxPayload>,
);
...
export const ProductAccountTxPayload: S.Codec<ProductAccountTxPayload> = S.lazy(
  (): S.Codec<ProductAccountTxPayload> =>
    S.Struct({
      signer: ProductAccountId,
      genesisHash: GenesisHash,
      callData: S.Hex(),
      extensions: S.Vector(TxPayloadExtension),
      txExtVersion: S.u8,
    }) as S.Codec<ProductAccountTxPayload>,
);
...
export const TxPayloadExtension: S.Codec<TxPayloadExtension> = S.lazy(
  (): S.Codec<TxPayloadExtension> =>
    S.Struct({
      id: S.str,
      extra: S.Hex(),
      additionalSigned: S.Hex(),
    }) as S.Codec<TxPayloadExtension>,
);
