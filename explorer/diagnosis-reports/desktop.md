...
| `Payment/status_subscribe`                       | ❌     | topUp failed: { "tag": "Unknown", "value": { "reason": "Not implemented" } }                              |
| `Permissions/request_device_permission`          | ✅     |                                                                                                           |
| `Permissions/request_remote_permission`          | ✅     |                                                                                                           |
| `Preimage/lookup_subscribe`                      | ❌     | submit failed: { "tag": "Unknown", "value": { "reason": "Not implemented" } }                             |
| `Preimage/submit`                                | ❌     | { "tag": "Unknown", "value": { "reason": "Not implemented" } }                                            |
